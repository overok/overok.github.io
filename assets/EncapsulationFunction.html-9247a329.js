import{_ as n,o as s,c as a,a as p}from"./app-17948464.js";const t={},e=p(`<h1 id="封装" tabindex="-1"><a class="header-anchor" href="#封装" aria-hidden="true">#</a> 封装</h1><h2 id="new-函数" tabindex="-1"><a class="header-anchor" href="#new-函数" aria-hidden="true">#</a> new 函数</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token number">1.</span>创建一个空对象，作为将要返回的对象实例。
